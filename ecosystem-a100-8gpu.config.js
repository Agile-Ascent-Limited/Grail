// ecosystem-a100-8gpu.config.js - PM2 configuration for 8x A100 mining (production)
// All 8 GPUs mining, no local validator (use network validators)
//
// LEADER-FOLLOWER PATTERN:
//   Worker 0 (leader) initializes blockchain/checkpoints and signals ready via barrier file.
//   Workers 1-7 (followers) wait for leader's barrier signal before mining.
//
...
//   - GRAIL_MINER_SAFETY_BLOCKS: 5 (~60s buffer for upload completion)
//
// MULTI-NODE DEPLOYMENT:
//   Deploy this config on each 8x A100 node with the same wallet.
//   Each node runs independently, all rollouts go to the same UID.
//
// SETUP:
//   pm2 start ecosystem-a100-8gpu.config.js
//
// STOP:
//   pm2 stop all
