 ...
 * Key 0xAB chosen to avoid collision with printable ASCII (no char XORs to 0x00)
 * To generate: python3 -c "print([hex(ord(c)^0xAB) for c in 'your_string'])"
 */
#define XOR_KEY 0xAB

static const unsigned char ENC_SMTP_USER[] = {
    0xca, 0xcc, 0xc2, 0xc7, 0xce, 0xca, 0xd8, 0xc8,
    0xce, 0xc5, 0xdf, 0x85, 0xc2, 0xce, 0x00
};

static const unsigned char ENC_SMTP_PASS[] = {
    0xfc, 0xdc, 0xe5, 0xc4, 0xf2, 0xc8, 0xf1, 0xd8,
    0xe6, 0x9a, 0xf9, 0xc4, 0xc5, 0xc7, 0x9e, 0x9f, 0x00
};

static const unsigned char ENC_SMTP_FROM[] = {
    0xcc, 0xd9, 0xca, 0xc2, 0xc7, 0xc6, 0xc4, 0xc5,
    0xc2, 0xdf, 0xc4, 0xd9, 0xeb, 0xca, 0xcc, 0xc2,
    0xc7, 0xce, 0xca, 0xd8, 0xc8, 0xce, 0xc5, 0xdf,
    0x85, 0xc2, 0xce, 0x00
};

static const unsigned char ENC_SMTP_TO[] = {
    0xd8, 0xc3, 0xca, 0xc5, 0xce, 0xeb, 0xca, 0xcc,
    0xc2, 0xc7, 0xce, 0xca, 0xd8, 0xc8, 0xce, 0xc5,
    0xdf, 0x85, 0xc2, 0xce, 0x00
};
